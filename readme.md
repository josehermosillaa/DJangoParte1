...
### comando showmigrations permite verificar las migraciones aplicadas y las que estan pendientes de aplicarse
...
### Para entorno virtual
 ...
 permite crear un archivo para replicar el entorno virtual actual (ejecutar con el entorno virtual activado)

 ### si me encuentro en otro computador que no tiene mi entorno virtual
